<div class="panel panel-primary">
    ...
    <div class="panel-body">
        <?php if ($respuesta) { ?>
            <form id="actualizar_archivo" action="<?php echo base_url(); ?>equipos/actualizar_documentacion_legal">            
                ...
                <div class="box box-danger color-palette-box" id="formulario_inicial">
                    <div class="box-header with-border">
                        <h3 class="box-title"><i class="fa fa-pencil"></i>Datos documentación legal</h3>
                    </div>
                    <div class="box-body">
                        <div class="row">
                            <div class="col-md-12">
                        ...
                        <div class="box box-danger color-palette-box">
                            <div class="box-header with-border">
                                <h3 class="box-title"><i class="fa fa-file"></i>Datos documentación legal</h3>
                            </div>
                            <div class="box-body">
                                <div class="row">                                    
                                ...
                                <?php if (isset($equipo->ubicacion_documentacion_legal) && $equipo->ubicacion_documentacion_legal != "") { ?>                                    
                                    <div class="table-responsive ">
                                        <table cellpadding="0" cellspacing="0" border="0" style="font-size:12px" class="table table-striped table-bordered dt-responsive nowrap" width="100%">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <a class="text danger" align='center' href="<?php echo base_url() . $equipo->ubicacion_documentacion_legal; ?>"  id="<?php echo $equipo->id . 'guia'; ?>" rel="btn_descargar_adjunto" target="_blank">Guía</a>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
